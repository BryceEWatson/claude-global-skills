...
| [`transcript-analysis`](transcript-analysis/) | Single-project Cowork transcript miner → proposes that project's `CLAUDE.md` candidates. (The single-project sibling of `review-globals-loop`.) |
